...
Sama XML::Filter::GenericChunk jest abstrakcyjną klasą, więc jako
filtr nie da żadnego przydatnego wyjścia. Jeśli potrzebny jest prosty
filtr Chunk dla potoków SAX, można sprawdzić klasę
